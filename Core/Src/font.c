...
const Font shedingzhi1 = {.w =12, .h = 12, .chars = (const uint8_t *)shedingzhi,.len = sizeof(shedingzhi)/28, .ascii = &afont16x8};
...
const uint8_t xuanzeshuchuleixing[][28] = {
...
const Font xuanzeshuchuleixing1 = {.w =12, .h = 12, .chars = (const uint8_t *)xuanzeshuchuleixing,.len = sizeof(xuanzeshuchuleixing)/28, .ascii = &afont16x8};
